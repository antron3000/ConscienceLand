...
async function approve(_to,_tokenId) {
	await contract.approve(_to,_tokenId)
}

async function transferFrom(_from,_to,_tokenId) {
	await contract.transferFrom(_from,_to,_tokenId)
}

async function propose(_content,_titleId) {
	await contract.propose(_content,_titleId)
}

async function approveProposal(_proposalId){
	await contract.approveProposal(_proposalId);
}

async function issueTitle(_content) {
	await contract.issueTitle(_content)
}
